Pod::Spec.new do |s|
  ...
  s.homepage               = "https://github.com/LMTKit/XCDYouTubeKit"
  s.screenshot             = "https://raw.github.com/LMTKit/XCDYouTubeKit/#{s.version}/Screenshots/XCDYouTubeVideoPlayerViewController.png"
  s.license                = { :type => "MIT", :file => "LICENSE" }
  s.author                 = { "Cédric Luthi" => "cedric.luthi@gmail.com" }
  s.social_media_url       = "https://twitter.com/0xced"
  s.source                 = { :git => "https://github.com/LMTKit/XCDYouTubeKit", :tag => s.version.to_s }
